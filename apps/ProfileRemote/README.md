...
ProfileRemote is a **Module Federation remote application** built with React Native and Re.Pack. It exposes a Profile module that can be dynamically loaded and consumed by the host application (`RepackApp`) at runtime.

## Overview

- **Type**: Module Federation Remote
- **Framework**: React Native 0.81.5 with Re.Pack 5.2.3
- **Purpose**: Exposes a reusable Profile component that can be consumed by other apps in the monorepo
...
│   └── module/
│       └── Profile/
│           └── index.tsx    # Exposed Profile component
