  ...
  return Repack.defineRspackConfig({
    ...
    plugins: [
      ...
      new Repack.plugins.ModuleFederationPluginV2({
        name: 'ShippingAddressRemote',
        filename: 'ShippingAddressRemote.container.js.bundle',

        exposes: {
          './ShippingAddress': './src/module/ShippingAddress/index.tsx',
        },
...
export default withZephyr({
  applicationUid: 'shippingaddressremote.re-pack-training.tiennd0502',
})(config);
